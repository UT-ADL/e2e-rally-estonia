...
class NvidiaDriveImporter:
    ...
    def __init__(self, bag_files, extract_dir):
        ...
        self.topics = self.camera_topics + [self.steer_topic, self.speed_topic, self.autonomy_topic]
    ...
    def import_bag(self, bag_file):
        ...
        for topic, msg, ts in bag.read_messages(topics=self.topics):
            ...
            if topic == self.autonomy_topic:
                ...
                #     #print("-----------------")
                #     #print("turn_topic: ", msg.enabled)
                #     turn_dict["turn_signal"].append(msg.enabled)
        ...
        merged = functools.reduce(lambda left, right:
                                  ...
                                  [front_wide_camera_df, left_camera_df, right_camera_df, speed_df, steering_df])
