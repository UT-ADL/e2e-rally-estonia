...
if __name__ == "__main__":
    ...
    datasets = {
        'Lidar v1': read_frames([root_path / '2021-11-25-12-57-24_e2e_rec_elva-lidar-v1-0.8-forward'], "lidar_frames.csv"),
        'Lidar v2': read_frames([root_path / '2021-11-25-14-39-43_e2e_rec_elva-lidar-v2-0.8-forward'], "lidar_frames.csv"),
        'Lidar v3': read_frames([root_path / '2021-11-25-15-27-38_e2e_rec_elva-l-lidar-v3-0.8-forward'], "lidar_frames.csv"),
        'Lidar in train': read_frames([root_path / '2021-11-25-13-48-44_e2e_rec_elva-lilidar-inTrain-0.8-forward'], "lidar_frames.csv"),
