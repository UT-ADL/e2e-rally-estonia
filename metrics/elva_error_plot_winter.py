...
if __name__ == "__main__":
    ...
    datasets = {
        'Lidar v1 winter': read_frames_driving([root_path / '2022-02-02-11-32-37_e2e_rec_elva_winter_lidar-v3_forw_08'],
                                       "lidar_frames.csv"),
        'Lidar v2 winter': read_frames_driving([root_path / '2022-02-02-10-39-23_e2e_rec_elva_winter_lidar_forward_08',
                                                root_path / '2022-02-02-10-50-07_e2e_rec_elva_winter_lidar_forward_08'],
                                       "lidar_frames.csv"),
        'Lidar v3 winter': read_frames_driving([root_path / '2022-02-02-11-05-18_e2e_rec_elva_winter_lidar-v5_forw_08'],
                                       "lidar_frames.csv"),

        'Camera v3 winter': read_frames_driving([root_path / '2022-02-02-11-58-48_e2e_rec_elva_winter_camera-v3_forw_08'],
                                        "nvidia_frames.csv"),
    }

    datasets_backwards = {
        'Lidar v1 winter': read_frames_driving([root_path / '2022-02-02-11-45-34_e2e_rec_elva_winter_lidar-v3_backw_08'],
                                       "lidar_frames.csv"),
        'Lidar v2 winter': read_frames_driving([root_path / '2022-02-02-10-53-16_e2e_rec_elva_winter_lidar_backw_08'],
                                       "lidar_frames.csv"),
        'Lidar v3 witer': read_frames_driving([root_path / '2022-02-02-11-18-14_e2e_rec_elva_winter_lidar-v5_backw_08'],
                                      "lidar_frames.csv"),
    }
